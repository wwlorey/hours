...
| `min_weekly_average` | `f64` | `15.0` | Minimum average **total** supervised hours per week. All four categories (`direct`, `indirect`, `individual_supervision`, `group_supervision`) count toward this metric. See [summary-system.md § Weekly Average](./summary-system.md#weekly-average). |
